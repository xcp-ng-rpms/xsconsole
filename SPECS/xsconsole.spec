...
%changelog
* Mon Sep 01 2025 Guillaume Thouvenin <guillaume.thouvenin@vates.tech> - 11.0.9.1-1.1
- Sync with 11.0.9.1
- Remove xsconsole-11.0.8-sync-network-reset-trigger-file.patch
- Remove xsconsole-11.0.8-do-not-truncate-ipv6-in-pool-config-on-reset.patch
- *** Upstream changelog ***
